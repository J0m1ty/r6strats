export const attackerGadgets = ["Ballistic Shield", "Breach Charge", "Hard Breach Charge", "Claymore", "Frag Grenade", "Smoke Grenade", "Stun Grenade", "Impact EMP Grenade"] as const;
